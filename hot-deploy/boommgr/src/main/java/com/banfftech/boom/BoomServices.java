...
import com.banfftech.personmanager.PersonManagerQueryServices;
...
import static com.banfftech.boom.BoomQueryServices.getMyGroup;
...
import static com.banfftech.platformmanager.common.PlatformLoginWorker.module;
...
//获得库存信息 getInventoryAvailableByFacility
    ...
    public static Map<String, Object> removeProductKeyword(DispatchContext dctx, Map<String, Object> context) throws GenericEntityException, GenericServiceException, UnsupportedEncodingException {
        //Service Head
        LocalDispatcher dispatcher = dctx.getDispatcher();
        Delegator delegator = dispatcher.getDelegator();
        Map<String, Object> result = ServiceUtil.returnSuccess();
...
//                <attribute name="workEffortTypeId" type="String" mode="IN" optional="false"/>
    ...
    public static Map<String, Object> setProductInventory(DispatchContext dctx, Map<String, Object> context)
        ...
        quantityStr = quantityStr==null?"0":quantityStr;
