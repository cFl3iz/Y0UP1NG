package com.banfftech.personmanager;
...
import com.banfftech.platformmanager.common.PlatformLoginWorker;
import org.apache.ofbiz.base.util.Debug;

import com.banfftech.platformmanager.util.HttpHelper;
import org.apache.ofbiz.base.util.UtilDateTime;
import org.apache.ofbiz.base.util.GeneralException;
import org.apache.ofbiz.base.util.ObjectType;
import org.apache.ofbiz.entity.condition.EntityExpr;
import com.banfftech.platformmanager.aliyun.util.HttpUtils;
import com.banfftech.platformmanager.constant.PeConstant;
import com.banfftech.platformmanager.util.EmojiHandler;
import com.banfftech.platformmanager.util.UtilTools;
...
import static com.banfftech.platformmanager.common.PlatformLoginWorker.getToken;
import static com.banfftech.platformmanager.wechat.WeChatUtil.getAccessToken;
import static com.banfftech.wechatminiprogram.WeChatMiniProgramServices.updateProductBizData;
import static com.banfftech.wechatminiprogram.WeChatMiniProgramServices.updateProductBizDataFromOrder;
    ...
    public static Map<String, Object> registerDk(DispatchContext dctx, Map<String, Object> context) throws GenericEntityException, GenericServiceException, UnsupportedEncodingException {
        ...
        if (captcha != null && !captcha.trim().equals("")) {
            ...
            if (checkCaptcha) {
                ...
                //注册后端流程
                com.banfftech.platformmanager.common.PlatformLoginWorker.updatePersonAndIdentificationLanguage(appId, admin, partyId, delegator, openId, userInfoMap, userLogin, dispatcher);
...
//                //找到上家的ID
                ...
                if(null != productAndCategoryMember ){
                      payToPartyId = productAndCategoryMember.getString("payToPartyId");
                }
                ...
                basePartyId = getBasePartyFromProduct(rowProductId,delegator);
//TODO FIX ME
                if ( EntityQuery.use(delegator).from("DkAgentForwardChainFact").where(
                    ...
                    createInMap.put("productId",rowProductId );
    ...
    private static String getBasePartyFromProduct(String rowProductId, Delegator delegator) throws GenericEntityException{
         ...
         GenericValue  hasBefore = EntityQuery.use(delegator).from("ProductAssoc").where(
                "productId", rowProductId ,"productAssocTypeId","PRODUCT_OBSOLESCENCE").queryFirst();
        if(hasBefore!=null){
            return getBasePartyFromProduct(hasBefore.getString("productIdTo"),delegator);
        }else{
            ...
            return productRoleAdmin.getString("partyId");
        }
...
//                gv.store();
    ...
    public Map<String, Object> useEmpPromo(DispatchContext dctx, Map<String, Object> context) throws GenericEntityException, GenericServiceException, Exception {
        ...
        partyId = (String)userLogin.get("partyId");
        com.banfftech.platformmanager.common.PlatformLoginWorker.createNewWeChatPerson2(admin, partyId, delegator, openId, userInfoMap, userLogin, dispatcher);
...
//                }
    ...
    public static Map<String, Object> updateGenericPersonInfo(DispatchContext dctx, Map<String, Object> context)
        ...
        com.banfftech.personmanager.PersonManagerServices.createContentAndDataResource(partyId, delegator, admin, dispatcher, "WeChatImg", imgPath, null);
        return result;
    }
    ...
    public static Map<String, Object> updatePartyInfo(DispatchContext dctx, Map<String, Object> context)
        ...
        com.banfftech.personmanager.PersonManagerServices.createContentAndDataResource(partyId, delegator, admin, dispatcher, "WeChatImg", avatarUrl, null);
