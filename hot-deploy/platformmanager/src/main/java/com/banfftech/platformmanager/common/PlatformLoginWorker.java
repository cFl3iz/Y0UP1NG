...
import static com.banfftech.platformmanager.util.HttpHelper.sendGet;
import com.banfftech.platformmanager.util.EmojiFilter;
...
//            }
            ...
            com.banfftech.platformmanager.common.PlatformLoginWorker.createNewWeChatPerson(admin, partyId, delegator, unionid, weChatUserInfo, userLogin, dispatcher);
    ...
    public static  void createNewWeChatPerson(GenericValue admin,String partyId,Delegator delegator,String unioId,Map<String,String> weChatUserInfo,GenericValue userLogin,LocalDispatcher dispatcher) throws GenericServiceException,GenericEntityException{
        ...
        //头像数据
        com.banfftech.personmanager.PersonManagerServices.createContentAndDataResource(partyId, delegator, admin, dispatcher, "WeChatImg", weChatUserInfo.get("headimgurl"),null);
        //将微信名称更新过来
       ...
       GenericValue miniProgramIdentification = EntityQuery.use(delegator).from("PartyIdentification").where("idValue", openId,"partyIdentificationTypeId","WX_MINIPRO_OPEN_ID").queryFirst();
        ...
        if(partyIdentificationList.size()>1){
            ...
            if(null != partyIdentificationList && partyIdentificationList.size()>0 && partyIdentificationList.get(0) != null){
                ...
                com.banfftech.platformmanager.common.PlatformLoginWorker.createNewWeChatPerson(admin,partyId,delegator,unioId,userInfoMap,userLogin,dispatcher);
...
//            result.put("userInfo", UserQueryServices.queryPersonWorkerInfo(delegator, miniProgramIdentification.getString("partyId")));
        ...
        if(user==null){
            ...
            com.banfftech.personmanager.PersonManagerServices.createContentAndDataResource(user.getString("partyId"), delegator, admin, dispatcher, "WeChatImg", avatarUrl,null);
        ...
        com.banfftech.platformmanager.common.PlatformLoginWorker.createNewWeChatPerson2(admin, partyId, delegator, openId, userInfoMap, user, dispatcher);
