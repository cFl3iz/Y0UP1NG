...
public class FilterExpressionVisitor implements ExpressionVisitor<Object> {
	...
	public static final String module = FilterExpressionVisitor.class.getName();
	@Override
	...
	public Object visitBinaryOperator(BinaryOperatorKind operator, Object left, Object right)
	    ...
	    Debug.logInfo("------------------- Entering visitBinaryOperator", module);
	...
	private Object evaluateComparisonOperation(BinaryOperatorKind operator, Object left, Object right) throws ODataApplicationException {
	    ...
	    // Debug.logInfo("------------------- Entering evaluateComparisonOperation", module);
	...
	public Object visitEnum(EdmEnumType arg0, List<String> arg1)
			throws ExpressionVisitException, ODataApplicationException {
	    Debug.logInfo("------------------- Entering visitEnum", module);
	    throw new ODataApplicationException("Enum are not implemented",
                HttpStatusCode.NOT_IMPLEMENTED.getStatusCode(), Locale.ENGLISH);
	}
	...
	public Object visitLambdaExpression(String arg0, String arg1, Expression arg2)
			throws ExpressionVisitException, ODataApplicationException {
	    Debug.logInfo("------------------- Entering visitLambdaExpression", module);
	    throw new ODataApplicationException("Lambda are not implemented",
                HttpStatusCode.NOT_IMPLEMENTED.getStatusCode(), Locale.ENGLISH);
	}

	@Override
	public Object visitLambdaReference(String arg0) throws ExpressionVisitException, ODataApplicationException {
	    Debug.logInfo("------------------- Entering visitLambdaReference", module);
	    throw new ODataApplicationException("Lambda reference are not implemented",
                HttpStatusCode.NOT_IMPLEMENTED.getStatusCode(), Locale.ENGLISH);
	}
	...
	public Object visitLiteral(Literal literal) throws ExpressionVisitException, ODataApplicationException {
	    ...
	    Debug.logInfo("------------------- Entering visitLiteral", module);
	    Debug.logInfo("------------------- literal = " + literal, module);
	...
	public Object visitMember(Member member) throws ExpressionVisitException, ODataApplicationException {
	    Debug.logInfo("------------------- Entering visitMember", module);
	    Debug.logInfo("------------------- member = " + member, module);
	...
	public Object visitMethodCall(MethodKind methodCall, List<Object> parameters)
			throws ExpressionVisitException, ODataApplicationException {
	    Debug.logInfo("------------------- Entering visitMethodCall", module);
	...
	public Object visitTypeLiteral(EdmType arg0) throws ExpressionVisitException, ODataApplicationException {
	    Debug.logInfo("------------------- Entering visitTypeLiteral", module);
	...
	public Object visitUnaryOperator(UnaryOperatorKind operator, Object operand)
	    ...
	    Debug.logInfo("------------------- Entering visitUnaryOperator", module);
	...
	public FilterExpressionVisitor(Entity currentEntity) {
	    Debug.logInfo("------------------- Entering FilterExpressionVisitor", module);
