package com.banfftech.platformmanager.wechat;
...
import static com.banfftech.platformmanager.util.HttpHelper.sendPost;
...
public class WeChatUtil {
    ...
    public static Map<String,Object> getWeChatAccess(String code)  {
        ...
        String responseStr = com.banfftech.platformmanager.util.HttpHelper.sendGet(PeConstant.WX_ACCESS_PATH, requestParamSB.toString());
...
//        System.out.println("==================================================openId= " +context.get("openId"));
        ...
        // Do HTTP Get
        String responseStr = com.banfftech.platformmanager.util.HttpHelper.sendGet(PeConstant.WX_USER_INFO_CGI_BIN_PATH,requestParamSB.toString());
        ...
        String jsonUserInfoMapStr = com.banfftech.platformmanager.util.HttpHelper.sendGet(PeConstant.WX_USER_INFO_PATH,requestParamUserInfoSB.toString());
