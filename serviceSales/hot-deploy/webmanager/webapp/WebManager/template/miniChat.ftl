               ...
               //     alert("bool = " + bool+"");
                    ...
                    if (bool) {
                        if(null != messageLogTypeId && messageLogTypeId === "IMAGE"){
                            ...
                            text = text + "?x-oss-process=image/resize,w_100,h_80/quality,q_85";
                            ans += '<div class="answer_text"><a href="javascript:alert(${uiLabel.DefaultAction});"><img style="width:100px;height:80px;no-repeat;"  src=' + text + '></img></a><i></i>';
                            ans += '</div></div>';
                     ...
                     //   for_bottom();
                      //  for_bottom();
                        ...
                        if(null != messageLogTypeId && messageLogTypeId === "IMAGE"){
                            ...
                            str += '<div class="question_text clear"><a href="javascript:alert(${uiLabel.DefaultAction});"><img style="width:100px;height:80px;no-repeat;"  src=' + text + '></img></a><i></i>';
                            str += '</div></div>';
