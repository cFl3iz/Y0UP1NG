               ...
               //     alert("bool = " + bool+"");
                    ...
                    if (bool) {
                        if(null != messageLogTypeId && messageLogTypeId === "IMAGE"){
                            ...
                            ans += '<div class="answer_text"><img style="width:80;height:80px;no-repeat;"  src=' + text + '></img><i></i>';
                            ans += '</div></div>';
                     ...
                     //   for_bottom();
                      //  for_bottom();
                        ...
                        if(null != messageLogTypeId && messageLogTypeId === "IMAGE"){
                            ...
                            str += '<div class="question_text clear"><img style="width:80;height:80px;no-repeat;"  src=' + text + '></img><i></i>';
                            str += '</div></div>';
