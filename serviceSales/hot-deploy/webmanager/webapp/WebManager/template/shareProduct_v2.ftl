...
<script>
    ...
    function doWeChatAccess(){
        ...
        var fromurl = "http://www.vivafoo.com/oauth2_buy_product.php?productId="+"${(productId)!}"+"&payToPartyId="+"${(resourceDetail.payToPartyId)!}"+"&prodCatalogId="+"${(resourceDetail.prodCatalogId)!}"+"&productStoreId="+"${(resourceDetail.productStoreId)!}";
...
${(resourceDetail.detailImageUrl?default('http://personerp.oss-cn-hangzhou.aliyuncs.com/datas/serviceSales/banner3.png'))!}" alt="" /> </a>
                ...
                <ul class="table-view" style="margin-top: 10px;">
                    <li class="table-view-cell media"> <a class="">
                        <img class="media-object pull-left" style="width: 50%;height:50%;" src="${(resourceDetail.headPortrait?default('http://placehold.it/42x42'))!}" />
